...
Generated: 2026-07-20T19:50:49.782Z | focus: lifecycle | from: 26 records | budget: 12000 chars

> Point-in-time snapshot. Live memory is at ~/.zentext/projects/393cd1fa3aa3ce69/store.sqlite

## Active task
- Design MCP server lifecycle (blocked)
...
- Implement memory.read MCP tool (active) — Next: Define the tool schema and add a thin stdio server wrapper around the existing Store interface.
